    ...
    def acertoOperador(self,dta):
        ...
        for row in varLojas:
           ...
           #Apagando a informação na caixa de data.
                            ...
                            #  varFuncao.show_popup(mensagem)
                              ...
                              if devolucao != "":
                                 ...
                                 if devolucao_float > 0.0:
                                    ...
                                    pyautogui.sleep(4)
                                    varFuncao.InsertOutros(devolucao, controleOutros_box)
                                    pyautogui.sleep(2)
                           ...
                           #   srtDinheiroSistema = srtDinheiroSistema_2.window_text()
                             ...
                             # window = None                                                                                                                                          
                              ...
                              if varControleDigitacao >= "1":
                                 ...
                                 pyautogui.sleep(0.25)
                                 guptadialog_01[u'Valor TotalButton2'].click_input() # Confirma e fecha a janela outros    
                                 varControleDigitacao =None 
                              ...
                              if varControleDigitacao >= "1":
                                 ...
                                 pyautogui.sleep(1.5)
                                 guptadialog_01[u'Valor TotalButton2'].click_input() # Confirma e fecha a cheque a vista
                              ...
                              if varControleDigitacao >= "1":
                                 ...
                                 pyautogui.sleep(1.5)
                                 guptadialog_01[u'Valor TotalButton2'].click_input() # Confirma e fecha a cheque a prazo
                              ...
                              if varControleDigitacao >= "1":
                                 ...
                                 guptadialog_01[u'Button6'].click_input() # Confirma e fecha a janela credito
                                 pyautogui.sleep(4) 
                              ...
                              if varControleDigitacao >= "1":
                                 ...
                                 pyautogui.sleep(1.5)
                                 guptadialog_01[u'Valor TotalButton2'].click_input() # Confirma e fecha a janela debito
                                 pyautogui.sleep(3)
                              ...
                              if varControleDigitacao >= "1":
                                 ...
                                 pyautogui.sleep(1.5)
                                 guptadialog_01[u'Valor TotalButton2'].click_input() # Confirma e fecha a janela Ticket
                                 pyautogui.sleep(2)
                              ...
                              if varControleDigitacao >= "1":
                                 ...
                                 pyautogui.sleep(1)
                                 guptadialog_01[u'Valor TotalButton2'].click_input() # Confirma e fecha a janela Cancelamento
                                 pyautogui.sleep(1)
                              ...
                              if varControleDigitacao >= "1":
                                 ...
                                 pyautogui.sleep(1.5)
                                 guptadialog_01[u'Valor TotalButton2'].click_input() # Confirma e fecha a janela Convenio
                                # pyautogui.sleep(1.5)
                              ...
                              if varControleDigitacao >= "1":
                                 ...
                                 pyautogui.sleep(1.5)
                                 guptadialog_01[u'Valor TotalButton2'].click_input() # Confirma e fecha a janela Carteira Digital
                                 pyautogui.sleep(1)
            ...
            #Metodo que apaga o arquivo digitado
        ...
        guptamdiframeAcer_Operador[u'Button24'].click_input() #Clicando no botao fechar   
